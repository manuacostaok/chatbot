...
![](https://github.com/manuacostaok/chatbot/blob/main/TP%20Inicial.png)
...
Como hemos visto anteriormente, en el Onboarding Digital la IA juega un rol central, ya que es utilizada para convertir al proceso en uno más eficiente, personalizado y orientado a las necesidades del usuario. En dicho proceso se llevan a cabo distintas disciplinas tecnológicas, tales como la verificación de identidad a través de la biometría y el análisis de documentos de identidad, lo que mejora la experiencia del usuario y reduce los riesgos de fraude y suplantación de identidad. Además, con la implementación de las Listas AML, la IA ha demostrado ser una herramienta central en cuestiones de seguridad de alto nivel, siendo utilizada en organismos gubernamentales a gran escala.
